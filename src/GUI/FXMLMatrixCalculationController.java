...
public class FXMLMatrixCalculationController {
	   @FXML
	    ...
	    @FXML
	    private TextField textFieldMatrix105;

	    @FXML
	    private TextField textFieldMatrix106;

	    @FXML
	    private TextField textFieldMatrix107;

	    @FXML
	    private TextField textFieldMatrix104;

	    @FXML
	    private TextField textFieldMatrix108;

	    @FXML
	    private TextField textFieldMatrix112;

	    @FXML
	    private TextField textFieldMatrix116;

	    @FXML
	    private TextField textFieldMatrix115;
	    ...
	    @FXML
	    private TextField textFieldMatrix109;

	    @FXML
	    private TextField textFieldMatrix114;
